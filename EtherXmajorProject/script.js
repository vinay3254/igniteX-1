  ...
  container.innerHTML = `
    <div class="page-container page-enter">
      ...
      <div class="about-mission">
        <h2>Our Mission</h2>
        <p>Our mission is to build innovative and secure digital technologies that empower individuals and organizations while protecting data ownership and privacy. We aim to develop scalable solutions in areas such as artificial intelligence, blockchain, cybersecurity, and emerging technologies that contribute to a stronger digital ecosystem.</p>
        <p style="margin-top:16px;">Through responsible innovation and continuous research, we strive to create impactful products that support technological independence and drive meaningful progress for India and the global community.</p>
      </div>
      ...
      <div class="about-team">
        ...
        <div class="team-grid">
          ${[
            ...
            {name:"Sarah Kim",role:"Head of Product",img:"/meghana.jpeg"},
